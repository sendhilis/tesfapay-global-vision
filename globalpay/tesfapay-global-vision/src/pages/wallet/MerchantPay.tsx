      ...
      {mode === "qr" ? (
        <div className="text-center">
          ...
          <div className="glass rounded-2xl p-3 text-left">
            ...
            <p className="text-xs text-muted-foreground">All ABX merchants display a standard QR code. Scan once to pay in seconds and earn Global Points automatically.</p>
          </div>
        </div>
      ) : (
        <>

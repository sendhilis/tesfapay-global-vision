  ...
  return {
    ...
    intents: {
      ...
      sampleUtterances: [
        ...
        "Raise the daily ATM limit on my card",
    ...
    kb: {
      ...c.kb,
      // Only the bank's own URL — fetched & indexed live by the sandbox edge
      // function so the agent grounds strictly on this bank's cards content.
      docs: [
        {
          id: `doc-card-url-${Date.now()}`,
          name: kbUrl,
          type: "url",
          size: "live",
          status: "indexed",

export type ModuleId =
  | "entry" | "M1" | "M2" | "M3" | "M4" | "M5" | "M6" | "review";
...
export const MODULES: { id: ModuleId; code: string; name: string; desc: string }[] = [
  ...
  { id: "M4",     code: "04", name: "AI Concierge",     desc: "Tone & agents" },
  { id: "M5",     code: "05", name: "Onboarding",       desc: "KYC & account opening" },
  { id: "M6",     code: "06", name: "Compliance",       desc: "Ethiopia · Fayda · NBE" },
  { id: "review", code: "07", name: "Review & Go Live", desc: "Publish BankConfig" },
];

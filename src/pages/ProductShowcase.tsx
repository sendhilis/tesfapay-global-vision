...
import {
  ...
  Network, Layers, Fingerprint, Bell, Clock, Shield, Target, Award
} from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-50 glass border-b border-border print:hidden">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between px-6 py-3">
          ...
          <Button size="sm" onClick={handleExportPDF} className="bg-gradient-gold text-foreground font-bold hover:opacity-90">
      ...
      <div ref={contentRef} className="bg-background text-foreground">
        ...
        <section className="relative min-h-[1120px] flex flex-col items-center justify-center overflow-hidden" style={{ background: "hsl(220 35% 6%)" }}>
          ...
          <div className="relative z-10 text-center max-w-3xl px-8">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-4 font-light">
              Africa's Most Advanced AI-Powered Mobile Money Platform
            </p>
            <p className="text-sm text-muted-foreground/70 mb-12">
              Built for Global Bank Ethiopia · Engineered by TechMonk
            </p>
            <div className="flex flex-wrap justify-center gap-4 mb-16">
              {["14 Core Modules", "50+ AI Features", "NBE Compliant", "Agent & Merchant Networks"].map(t => (
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-12 items-center">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: Receipt, title: "Bill Payments", desc: "Pay utilities (EELPA, Ethio Telecom), school fees, tax, insurance — 200+ billers integrated via single API." },
                  ...
                  { icon: Coins, title: "Airtime & Data Top-Up", desc: "Top-up any Ethiopian mobile network. Auto-recharge rules, family plans, bulk purchases for enterprises." },
                ].map(f => (
        ...
        <section className="min-h-[1120px] py-20 px-8" style={{ background: "hsl(220 30% 7%)" }}>
          <div className="max-w-5xl mx-auto">
            <SectionHeader icon={Building2} title="Agent Banking Network" subtitle="Extending financial services to every corner of Ethiopia" number="02" />
        ...
        <section className="min-h-[1120px] py-20 px-8">
          <div className="max-w-5xl mx-auto">
            <SectionHeader icon={Brain} title="AI Copilot — Tesfa AI" subtitle="Intelligent automation across every layer of the platform" number="03" />
            <div className="grid md:grid-cols-2 gap-12 mt-12 items-center">
              <div className="space-y-6">
                {[
                  { icon: Bot, title: "Conversational Banking", desc: "Natural language transactions in Amharic, Oromo, Tigrinya & English. Voice-first interface for low-literacy users." },
                  { icon: Eye, title: "Fraud Detection Engine", desc: "Real-time anomaly detection using ML models trained on Ethiopian transaction patterns. 99.7% accuracy rate." },
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                ...
                { icon: Coins, title: "E-Money Management", items: ["Issuance & redemption", "Trust fund reconciliation", "Float monitoring", "NBE reserve compliance"] },
        ...
        <section className="min-h-[1120px] py-20 px-8">
          <div className="max-w-5xl mx-auto">
            <SectionHeader icon={ShieldCheck} title="Security & Regulatory Compliance" subtitle="Banking-grade security meeting NBE directives" number="05" />
            <div className="grid md:grid-cols-2 gap-12 mt-12 items-center">
              <div className="flex justify-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: FileCheck, title: "NBE Directives", desc: "FIS/01/2012, ONPS/01/2020, AML/CFT compliance" },
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-16 glass rounded-2xl p-8 border border-border">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { name: "Core Banking", desc: "T24, Flexcube, Finacle" },
                  { name: "Payment Switch", desc: "EthSwitch, VISA, M/C" },
                  { name: "Telco APIs", desc: "Ethio Telecom, Safaricom" },
                  { name: "Identity", desc: "National ID, Passport DB" },
                  { name: "Credit Bureau", desc: "CBE Information Center" },
                  { name: "Tax & Revenue", desc: "ERCA e-Tax Gateway" },
                  { name: "Utilities", desc: "EELPA, Water, Internet" },
                  { name: "Insurance", desc: "Ethiopian Insurance Corp" },
                ].map(i => (
        ...
        <section className="min-h-[1120px] py-20 px-8">
          <div className="max-w-5xl mx-auto">
            <SectionHeader icon={Star} title="Why GlobalPay?" subtitle="The competitive advantage for Global Bank Ethiopia" number="07" />
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              {[
                ...
                { icon: Globe, title: "Financial Inclusion", desc: "Agent network extends banking to 80M+ unbanked Ethiopians. USSD fallback ensures feature phone compatibility." },
                ...
                { icon: Landmark, title: "Regulatory Ready", desc: "Pre-mapped to all NBE directives with automated compliance reporting. Reduces regulatory risk and audit preparation time by 70%." },
            ...
            <div className="mt-16 glass rounded-2xl p-8 border border-primary/20">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  ...
                  { metric: "ETB 50B+", label: "Transaction Volume", sub: "Monthly throughput" },
                  { metric: "ETB 800M+", label: "Fee Revenue", sub: "Annual projection" },
        ...
        <section className="min-h-[1120px] flex flex-col items-center justify-center py-20 px-8 relative" style={{ background: "hsl(220 35% 6%)" }}>
          ...
          <div className="relative z-10 text-center max-w-2xl">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-extrabold text-foreground mb-4">
              Ready to Transform
              <br />
              <span className="text-primary">Ethiopia's Digital Finance?</span>
            </h2>
            <p className="text-muted-foreground text-lg mb-12">
              GlobalPay is more than a product — it's a platform for financial inclusion, powered by AI and built for scale.
            </p>
